...
<body>
<x-layout.nav />
<div class="input" style="padding: 20px; margin-left: 70px">
    <form action="{{ route('doctors.search') }}" method="get" style="flex-grow: 5; display: flex" >
        <input type="text" class="search" name="search" />
        <button  type="button" class="category-btn">
            category <img src="{{ asset('images/chevron-down.png') }}" alt="" />
        </button>
    </form>
    @php
        // get query string
        ...
        if ($query) {
            ...
            // set the title to rating
            $title = 'Top Vet Doctors';
        }
    @endphp

    <div class="category-box">
        <div>
            <img src="{{ asset('images/ratings.png') }}" />
            <a href="{{ route('doctors.order' , "order=rating") }}" class="ratings-scale">
                <p>Ratings</p>
                <p class="small">5 stars, 4 stars, 3 stars, 2 stars,...</p>
            </a>
        ...
        <div>
            <img src="{{ asset('images/trending-up.png') }}" alt="" />
            <a href="{{ route('doctors.order' , "order=exp") }}" class="ratings-scale">
                <p>Experience</p>
                <p class="small">20+ years, 10+ years, 5+ years,...</p>
            </a>
        ...
        <div>
            <img src="{{ asset('images/map-pin.png') }}" alt="" />
            <a href="{{ route('doctors.order' , "order=distance") }}" class="ratings-scale">
                <p>Distance</p>
                <p class="small">20km, 10km, 5km, 2km</p>
            </a>
        ...
        <div>
            <img src="{{ asset('images/dollar-sign.png') }}" alt="" />
            <a href="{{ route('doctors.order' , "order=price") }}" class="ratings-scale">
                <p>Price</p>
                <p class="small">10 Vet Doctors</p>
            </a>
            ...
            <a href="{{ route('doctors.details', $doctor->id) }}">
                ...
                <div class="user-details">
                    <div class="book">
                        ...
                        <a href="{{ route('appointment', $doctor->id) }}" class="books">
                            book appointment <img src="{{ asset('images/email.png') }}" alt="" />
                        </a>
                    </div>
                    <h4 class="doctor-name">{{ $doctor->name }}</h4>
                    <p>{{$doctor->experience }}+ years experience</p>
                    <div class="location">
                        <i class="fa fa-map-marker" aria-hidden="true"></i>
                        <p>{{ $doctor->location }}, Jos 5km away</p>
                    </div>
                </div>
            </a>
        </div>
